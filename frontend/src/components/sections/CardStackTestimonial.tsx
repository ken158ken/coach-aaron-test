...
const DEMO_CARDS: TestimonialSlide[] = [
  {
    ...
    quote:
      '跟阿倫教官學完銷售心法後，我的學生續課率從 40% 提升到 85%，真的不敢相信！',
  ...
  },
  {
    ...
    quote:
      '以前不敢開口報價，現在能自信地為學生設計專屬方案，阿倫教官的課讓我找到了自己的價值。',
  ...
  },
  {
    ...
    achievement: '年收突破百萬',
    quote:
      '學了 NLP 銷售技巧之後，每一次銷售對話都變得更自然，學生也感受到了真誠。',
  ...
  },
  {
    ...
    achievement: '招生滿班',
    quote:
      '不只是教練技術，阿倫教官幫我建立了整套經營思維，現在我的每堂課都是滿班狀態。',
  ...
  },
  {
    ...
    achievement: '個人品牌建立',
    quote:
      '從害怕銷售到享受銷售，阿倫教官讓我明白，真正的銷售是幫助學生看見自己的可能性。',
  ...
  },
  {
    ...
    quote:
      '學了阿倫教官的溝通技巧後，學生不只願意續課，還會主動幫我介紹新學生！',
...
const CardStackTestimonial: React.FC = () => {
  ...
  const cHeader = {
    tagline: get('review_tagline', 'Real Reviews'),
    title: get('review_title', '學員真實評價'),
    subtitle: get('review_subtitle', '每一個改變都是真實發生的'),
  };
  ...
  const groupCards = Array.from(
    { length: PER_PAGE },
    (_, i) => cards[(groupIdx * PER_PAGE + i) % cards.length]
  );
    ...
    <section className="py-16 sm:py-20 px-4 bg-transparent">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10 sm:mb-12">
          ...
          <p className="mt-2 text-sm text-white/40">{cHeader.subtitle}</p>
        </div>
