...
const CourseCard = ({ course }) => {
  return (
    <div className="card w-full bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="card-body">
        ...
        <div className="card-actions justify-end items-center mt-4">
          <div className="text-xl font-bold mr-auto text-primary">NT$ {course.price}</div>
