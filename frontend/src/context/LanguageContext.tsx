...
const zhTW: Translations = {
  ...
  exportFeature: {
    ...
    moduleExport: "分模組匯出",
    fullExport: "全站資料匯出",
    fullExportDesc: "將所有模組資料匯出為一份檔案（依上方選擇的格式），不含使用者密碼。",
    fullExportBtn: "下載全站資料",
    selectFormat: "選擇格式",
...
const en: Translations = {
  ...
  exportFeature: {
    ...
    fullExportDesc: "Export all modules into a single file (using the format selected above). User passwords are excluded.",
    fullExportBtn: "Download Full Site",
