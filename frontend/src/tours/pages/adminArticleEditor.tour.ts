  ...
  steps: [
    {
      ...
      titleEn: "Article editor",
      descEn: "This is where articles get written: <b>content on the left, publishing settings on the right</b>.<br>A new post and an old one you are fixing work the same way. Your text is auto-saved in the browser every 30 seconds, so a closed window costs you nothing.",
    },
    {
      el: '[data-tour="article-editor-title"]',
      title: "先給它一個標題",
      desc: "標題是<b>唯一必填</b>的欄位，沒填不能發布。前台的列表卡片、搜尋結果都吃這一行，寫得具體一點會比較好點。",
      titleEn: "Give it a title first",
      descEn: "The title is the <b>only required field</b> — without it you cannot publish. Cards on your public site and search results both use this line, so be specific and people will click.",
      side: "bottom",
      align: "start",
    },
    {
      ...
      descEn: "Works like Word: select the text, then hit <b>B / I / U</b> or a heading size. The right-hand group is media — <em>🖼️ image</em>, <em>🏞️ library</em>, <em>🎬 YouTube</em>, <em>🎙️ Loom</em>, <em>🔗 link</em>.<br>The next step demonstrates inserting an image.",
      side: "bottom",
      align: "start",
    },
    {
    ...
    },
    {
      ...
      titleEn: "URL slug",
      descEn: "The tail of the article's address, such as <code>/articles/my-first-post</code>. Lowercase letters, numbers and <code>-</code> only; <b>leave it blank and one is generated</b>. A duplicate turns red right below the field.",
      side: "left",
      align: "start",
    },
    {
      ...
      descEn: "The category decides which part of the site the article belongs to; press <b>Manage categories</b> to add your own. Tags below are added with <code>Enter</code> and mainly feed search engines and related-article suggestions.",
      side: "left",
      align: "start",
    },
    {
    ...
    },
    {
      ...
      descEn: "Already hosting the picture on Cloudinary? Switch to this tab, paste the link and press Apply. <b>The URL must start with <code>res.cloudinary.com</code></b> — anything else is rejected on the spot.<br>To swap the picture, press <b>Replace</b> under the preview.",
      side: "left",
      align: "start",
    },
    {
      ...
      titleEn: "Draft or published",
      descEn: "Not sure yet? Leave it a <b>draft</b> — it is saved but visible only in the admin, so readers never meet half-finished work. Switch it to <b>Published</b> and it joins the article list on your public site.",
      side: "left",
      align: "start",
    },
    {
      ...
      descEn: "<b>Save draft</b> stores it in this browser only — another computer will not see it. <b>Preview and publish</b> shows you the layout first, and only writes to the database once you confirm.<br>That is the tour — the <b>“?”</b> in the bottom-right corner replays it any time.",
      side: "bottom",
      align: "end",
    },
  ],
