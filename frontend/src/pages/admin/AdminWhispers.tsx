...
const AdminWhispers: React.FC = () => {
  ...
  return (
    <div>
          ...
          {whispers.map((w) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-sm text-luxe-text/80 leading-relaxed bg-luxe-bg/40 rounded-lg p-3 border border-luxe-gold/5">
                  {w.message}
                </p>
              </div>
            );
      ...
      <p className="mt-6 text-xs text-luxe-muted/50 text-center">
