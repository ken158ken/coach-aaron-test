      ...
      <div className="mt-6 card bg-base-100 shadow-md border border-base-300">
        <div className="card-body">
          ...
          <div className="space-y-2 text-sm">
            <p><span className="text-base-content/60">資料庫：</span>Supabase PostgreSQL</p>
            <p><span className="text-base-content/60">前端：</span>React + Vite + TailwindCSS + DaisyUI</p>
            <p><span className="text-base-content/60">後端：</span>Express.js</p>
            <p><span className="text-base-content/60">部署：</span>Vercel</p>
          </div>
        </div>
      </div>
    </div>
