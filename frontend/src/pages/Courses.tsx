 ...
 * 課程頁面元件
 *
 * 展示私人教練陪跑計畫的詳細資訊,包含課程方案、額外附贈課程、
 * 三大核心、三階段課程、制度說明和案例分享。
 *
 ...
 * 課程頁面元件
 *
 * 展示私人教練陪跑計畫的完整資訊,包含價格方案、課程內容和成功案例。
 *
 * @returns {JSX.Element} 課程頁面元件
 */
const Courses: React.FC = (): JSX.Element => {
  ...
  const totalBonusValue: number = bonuses.reduce((sum, b) => sum + b.value, 0);
   ...
   */
  const handlePlanSelect = (planId: number): void => {
    ...
    <div className="min-h-screen bg-base-100">
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-base-200 to-base-100">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-primary font-semibold mb-4 tracking-widest">
            私人教練專屬
          </p>
          ...
          <p className="text-2xl font-bold mb-8">
            讓你從<span className="text-primary">教練</span>變成
            <span className="text-primary">經營者</span>
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-base-200">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-center">
            目前的<span className="text-error">現狀</span>
          </h2>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="mt-8 text-xl font-semibold">
                大部分的教練缺一個<span className="text-primary">專業變現</span>
                系統
              </p>
            </div>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-center">
            從<span className="text-primary">知道</span>到
            <span className="text-primary">做到</span>的改變
          </h2>
          ...
          <div className="space-y-6">
            {systemFeatures.map((feature, index) => (
              ...
              >
                ...
                <p>
                  <span className="text-[#8B4D5C] font-bold">
                    {feature.highlight}
                  </span>
              ...
              <div key={index} className="card bg-base-100 shadow-xl">
                <div className="card-body">
                  ...
                  <div className="flex gap-6 text-sm mb-4">
                    <span>
                      <strong>{study.posts}</strong> 貼文
                    </span>
                    <span>
                      <strong>{study.followers}</strong> 位粉絲
                    </span>
                    <span>
                      <strong>{study.following}</strong> 追蹤中
                    </span>
                  </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {plans.map((plan) => (
              <div
                ...
                } bg-base-100 shadow-xl hover:shadow-2xl transition-all cursor-pointer ${
            ...
            <div className="card-body">
              <h3 className="text-2xl font-bold mb-4">
                ...
                <span className="text-primary">
                  NT$ {totalBonusValue.toLocaleString()}
                </span>
              </h3>
