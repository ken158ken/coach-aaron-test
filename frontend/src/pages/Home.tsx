 ...
 * 首頁元件
 *
 * 展示教練簡介、Podcast 內容、用戶評價和主題分類。
 *
 * @returns {JSX.Element} 首頁元件
 */
  ...
  const reviews: Review[] = [
    {
      ...
      date: "2021/12/14",
      content:
        "昨天晚上偶然發現的Podcast,內容實在、口條清晰,而且不會無聊!邊練邊聽很有意思💪💪💪",
      rating: 5,
    },
    {
      name: "adair014678",
    ...
    <div className="bg-base-100">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 space-y-6">
            ...
            <h2 className="text-4xl font-bold tracking-tight">
              關於 <span className="text-primary">阿倫教官</span>
            </h2>
            ...
            <div className="stats shadow bg-base-200 w-full">
              ...
              <div className="stat place-items-center">
                ...
                <div className="stat-value text-pink-500 text-xl">
                  @coach.luen
                </div>
      ...
      <section className="py-16 px-6 bg-base-200">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            聽眾<span className="text-primary">好評</span>
          </h2>
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            內容<span className="text-primary">主題</span>
          </h2>
