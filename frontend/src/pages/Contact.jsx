...
import { FaInstagram, FaFacebook, FaTiktok, FaPodcast, FaEnvelope, FaCommentDots } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-base-200 py-12 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4">聯絡 <span className="text-primary">阿倫教官</span></h1>
            ...
            <div className="card-body">
              ...
              <form className="space-y-4">
                <div className="form-control">
                  ...
                  <input type="text" placeholder="您的姓名" className="input input-bordered w-full" />
                </div>
                <div className="form-control">
                  <label className="label">
                ...
                <div className="form-control">
                  ...
                  <select className="select select-bordered w-full">
                    <option disabled selected>選擇主題</option>
                ...
                <div className="form-control">
                  ...
                  <textarea className="textarea textarea-bordered h-32" placeholder="請輸入您的訊息..."></textarea>
                </div>
          ...
          <div className="space-y-6">
                  ...
                  {socialLinks.map((social, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p className="font-bold group-hover:text-primary transition-colors">{social.name}</p>
                        <p className="text-sm text-base-content/60">{social.handle}</p>
                        <p className="text-xs text-base-content/50">{social.desc}</p>
                      </div>
                    </a>
                  ))}
                </div>
            ...
            <div className="card bg-primary text-primary-content">
              <div className="card-body">
                ...
                <p>
                  如果你對「私人教練陪跑計畫」有興趣，
                  可以先到<a href="/courses" className="underline font-bold">課程頁面</a>了解詳情，
                  再來諮詢會更有效率喔！
                </p>
              </div>
            </div>
